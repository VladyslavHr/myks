...
@section('page-title', 'Список коротких відео')
    ...
    <div class="tabel-responsive">
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    <th class="text-center" scope="row">{{ $trick->title }}</th>
                    <td class="text-center">{{ $trick->slug }}</td>
                    <td class="text-center">{{ $trick->category->title }}</td>
                    <td class="text-center">{{ $trick->updated_at->format('d-m-Y') }}</td>
                    <td class="text-center">{{ $trick->created_at->format('d-m-Y') }}</td>
                    <td class="text-center">
                        <a href="{{ route('admin.trick.edit', $trick) }}"><i class="bi bi-pencil-fill"></i></a>
                    </td>
                    <td class="text-center">
