...
<div class="container py-3">
    ...
    <form class="mt-3" action="{{ route('admin.videoLecture.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row">
            ...
            <div class="mb-3 col-md-4">
                ...
                <input name="video" value="{{ old('video') }}" type="text" class="form-control" id="">
            ...
            <div class="mb-3 col-md-4">
                ...
                <select class="form-select" name="video_lecture_category_id" >
