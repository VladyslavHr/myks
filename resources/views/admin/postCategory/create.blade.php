...
<div class="container py-3">
    ...
    <form class="mt-3" action="{{ route('admin.postCategory.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row">
            ...
            <div class="mb-3 col-md-12">
                <label for="description_post_category_create" class="form-label">Опис</label>
                <textarea name="description" class="form-control tinyeditor" id="description_post_category_create" cols="30" rows="10"
