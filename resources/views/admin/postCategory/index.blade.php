...
@section('page-title', 'Список категорій Блогу')
    ...
    <div class="tabel-responsive">
        <table class="table">
            ...
            <tr>
                ...
                <th class="text-center" scope="col">Кількість блогу</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <a href="{{ route('admin.postCategory.edit', $category) }}"><i class="bi bi-pencil-fill"></i></a>
                    </td>
                    <td class="text-center">
