...
<div class="container py-3">
    <div class="row py-3">
        <div class="col-md-2">
            <a class="btn " href="{{ route('admin.videoLectureCategory.index') }}">
                <i class="bi bi-arrow-left-square me-2"></i>
                Повернутись
            </a>
        </div>
    </div>
    <form class="mt-3" action="{{ route('admin.videoLectureCategory.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row">
            ...
            {{-- <div class="mb-3 col-md-6">
                ...
                <input name="name" value="{{ old('title') }}" type="text" class="form-control" id="">
