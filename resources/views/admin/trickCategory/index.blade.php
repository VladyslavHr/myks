...
@section('page-title', 'Список категорій коротких відео')
...
<div class="container py-3">
    <div class="row py-3">
        <div class="col-md-2">
            <a class="btn " href="{{ route('admin.trickCategory.create') }}">
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <a href="{{ route('admin.trickCategory.edit', $category) }}"><i class="bi bi-pencil-fill"></i></a>
                    </td>
                    <td class="text-center">
                        <form class="text-center" action="{{ route('admin.trickCategory.delete', $category) }}" method="POST"
